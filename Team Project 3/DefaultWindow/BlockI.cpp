...
void CBlockI::Initialize()
{
	...
	CBmpMgrS2::Get_Instance()->Insert_Bmp(L"../Resource/BlockI.bmp", L"BlockI");
...
void CBlockI::Render(HDC hDC)
{

	HDC		hMemDC = CBmpMgrS2::Get_Instance()->Find_Img(L"BlockI");
...
void CBlockI::Release()
{
}

void CBlockI::Key_Input()
{
	if (m_tInfo.vPos.y <= m_fLine - m_fCY * 3) {
